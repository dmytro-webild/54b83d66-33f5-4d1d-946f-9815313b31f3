...
export default function LandingPage() {
  ...
  <div id="sluzby" data-section="sluzby">
      ...
      description="RD Real plus zajišťuje kompletní stavební a energetická řešení pro rodinné domy. Postaráme se o vše – od architektonického návrhu, přes precizní realizaci a vyřízení nezbytné dokumentace až po vyřízení dotací, aby byla vaše cesta k vysněnému bydlení bezstarostná."
      accordionItems={[
        {
          id: "s1",          title: "Stavba domu na klíč",          content: "Realizujeme moderní rodinné domy na klíč s důrazem na vysoký standard, energetickou efektivitu a individuální potřeby klienta."},
        {
          id: "s2",          title: "Rekonstrukce",          content: "Kompletní rekonstrukce interiérů i exteriérů, které vdechnou vašemu domu nový život a zvýší jeho hodnotu."},
        {
          id: "s3",          title: "Energetická řešení a dotace",          content: "Navrhujeme a instalujeme fotovoltaické systémy a zajišťujeme kompletní servis pro vyřízení dotačních programů, aby byla vaše investice maximálně efektivní."},
      ]}
      ...
      columns={[
        {
          title: "RD Real plus s.r.o.",          items: [
            {
              label: "Klínová 620/1, 709 00 Ostrava",              href: "#"},
            {
